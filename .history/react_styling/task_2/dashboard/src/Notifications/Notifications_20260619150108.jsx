...
class Notifications extends Component {
  ...
  render() {
    return (
      <div className='Notification-Component flex flex-col items-end mr-2.5'>
        <div className="notification-title w-full text-right">
          <p>Your notifications</p>
        </div>
        {
          this.props.displayDrawer && <div className="notification-items w-full md:w-1/4 border-dashed border-[color:var(--main-color)] border-[2.5px] p-[6px] flex flex-wrap mb-4">
